...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} أيام  ماضية";

  static String m2(total) => "~${total} كم";

  static String m3(timeLeft) => "Ends in ${timeLeft}";

  static String m4(message) => "خطأ: ${message}";

  static String m5(time) => "تنتهي الصلاحية في ${time}";

  static String m6(total) => ">${total} كم";

  static String m7(hour) => "${hour} ساعات ماضية";

  static String m8(message) =>
      "حدثت مشكلة في التطبيق أثناء طلب البيانات ، يرجى الاتصال بالمسؤول لإصلاح المشكلة: ${message}";

  static String m9(size) => "أقصى حجم للملف: ${size} ميغابايت";

  static String m10(minute) => "${minute} دقائق ماضية";

  static String m11(month) => " قبل${month} شهر";

  static String m12(itemCount) => "${itemCount} عنصر";

  static String m13(price) => "إجمالي الخيارات: ${price}";

  static String m14(total) => "الكمية: ${total}";

  static String m15(percent) => "بيع ${percent} ٪";

  static String m16(second) => "${second} ثواني ماضية";

  static String m17(totalCartQuantity) =>
      "سلة التسوق, ${totalCartQuantity} عنصر";

  static String m18(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m19(total) => "${total} من المنتجات";

  static String m20(date) => "صالح حتى ${date}";

  static String m21(message) => "تحذير: ${message}";

  static String m22(default_currency) =>
      "العملة المحددة حاليًا غير متاحة لميزة المحفظة ، الرجاء تغييرها إلى ${default_currency}";

  static String m23(length) => "وجدنا منتجات ${length}";

  static String m24(week) => "الأسبوع ${week}";

  static String m25(year) => " قبل${year} سنة";

  static String m26(total) => "لقد قمت بتعيين الطلب رقم${total}";
