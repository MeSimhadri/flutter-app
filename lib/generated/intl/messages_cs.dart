...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => " Před${day} dny";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Končí za ${timeLeft}";

  static String m4(message) => "Chyba: ${message}";

  static String m5(time) => "Končí za ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => " Před${hour} hodinami";
  ...
  static String m9(size) => "Maximální velikost souboru: ${size} MB";

  static String m10(minute) => " Před${minute} minutami";

  static String m11(month) => " Před${month} měsíci";

  static String m12(itemCount) => " Položky:${itemCount} ";

  static String m13(price) => "Celkem možností: ${price}";

  static String m14(total) => "Množství: ${total}";

  static String m15(percent) => "Výprodej ${percent}%";

  static String m16(second) => " Před${second} s";

  static String m17(totalCartQuantity) =>
      "Nákupní košík, položky: ${totalCartQuantity} ";

  static String m18(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m19(total) => "${total} produktů";

  static String m20(date) => "Platí do ${date}";

  static String m21(message) => "Upozornění: ${message}";
  ...
  static String m23(length) => "Našli jsme ${length} produktů";

  static String m24(week) => "Týden ${week}";

  static String m25(year) => " Před${year} lety";

  static String m26(total) => "Přiřadili jste k objednávce č.${total}";
