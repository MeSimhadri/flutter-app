...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Mennyiség: ${total}";

  static String m15(percent) => "${percent} % Kedvezmény";

  static String m16(second) => "${second} másodperce";
  ...
  static String m19(total) => "${total} termék";

  static String m20(date) => "Érvényes: ${date}";

  static String m21(message) => "Figyelmeztetés: ${message}";
  ...
  static String m23(length) => "Találtunk ${length} terméket";

  static String m24(week) => " ${week}hét";

  static String m25(year) => "${year} évvel ezelőtt";

  static String m26(total) => "Hozzárendelte a (z)${total}számú megrendelést";
