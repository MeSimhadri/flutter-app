...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Qtd: ${total}";

  static String m15(percent) => "Desconto ${percent} %";

  static String m16(second) => "${second} segundos atrás";
  ...
  static String m19(total) => "${total} produtos";

  static String m20(date) => "Válido até ${date}";

  static String m21(message) => "Atenção: ${message}";
  ...
  static String m23(length) => "Encontramos ${length} produtos";

  static String m24(week) => "Semana ${week}";

  static String m25(year) => "${year} anos atrás";

  static String m26(total) => "Você atribuiu o pedido nº${total}";
