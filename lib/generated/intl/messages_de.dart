...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Menge: ${total}";

  static String m15(percent) => "Ausverkauf ${percent} %";

  static String m16(second) => "Vor ${second} Sekunden";

  static String m17(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m18(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m19(total) => "${total} Produkte";

  static String m20(date) => "Gültig bis ${date}";

  static String m21(message) => "Warnung: ${message}";
  ...
  static String m23(length) => "Wir haben die Produkte gefunden";

  static String m24(week) => "Woche ${week}";

  static String m25(year) => " Vor${year} Jahren";

  static String m26(total) => "Sie haben der Bestellung #${total}zugewiesen";
