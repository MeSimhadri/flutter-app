...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(percent) => "داشکاندن ${percent} %";

  static String m16(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m19(total) => "${total} بەرهەمەکان";

  static String m20(date) => "گونجاوە تا ${date}";

  static String m21(message) => "ئاگاداری: ${message}";

  static String m23(length) => "${length} بەرهەم دۆزرایەوە";
