...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Aantal: ${total}";

  static String m15(percent) => "Verkoop ${percent} %";

  static String m16(second) => "${second} seconden geleden";

  static String m17(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m18(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m19(total) => "${total} producten";

  static String m20(date) => "Geldig tot ${date}";

  static String m21(message) => "Waarschuwing: ${message}";
  ...
  static String m23(length) => "We hebben ${length} producten gevonden";

  static String m24(week) => "Week ${week}";

  static String m25(year) => "${year} jaar geleden";

  static String m26(total) => "Je hebt toegewezen aan bestelling #${total}";
