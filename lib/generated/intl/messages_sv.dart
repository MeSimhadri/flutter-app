...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Antal: ${total}";

  static String m15(percent) => "Försäljning ${percent}%";

  static String m16(second) => " För${second} sekunder sedan";

  static String m17(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m18(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m19(total) => "${total} produkter";

  static String m20(date) => "Gäller till ${date}";

  static String m21(message) => "Varning: ${message}";
  ...
  static String m23(length) => "Vi hittade ${length} produkter";

  static String m24(week) => "Vecka ${week}";

  static String m25(year) => " För${year} år sedan";

  static String m26(total) => "Du har tilldelat order nr${total}";
