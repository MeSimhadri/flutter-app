...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Količina: ${total}";

  static String m15(percent) => "Распродај ${percent} %";

  static String m16(second) => "Пре ${second} Минута";

  static String m17(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m18(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";

  static String m19(total) => "${total} proizvoda";

  static String m20(date) => "Датум истека ${date}";

  static String m21(message) => "упозорење: ${message}";
  ...
  static String m23(length) => "Пронашли смо производе";

  static String m24(week) => " ${week}. Sedmica";

  static String m25(year) => " Prije${year} godina";

  static String m26(total) => "Dodijelili ste narudžbi br.${total}";
