...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Qté: ${total}";

  static String m15(percent) => "Vente ${percent} %";

  static String m16(second) => "il y a ${second} secondes";
  ...
  static String m19(total) => "${total} Produits";

  static String m20(date) => "Valable jusqu\'au ${date}";

  static String m21(message) => "Warning: ${message}";
  ...
  static String m23(length) => "Nous avons trouvé des ${length} produits";

  static String m24(week) => "Semaine ${week}";

  static String m25(year) => " Il y a${year} ans";

  static String m26(total) => "Vous avez affecté à la commande n°${total}";
