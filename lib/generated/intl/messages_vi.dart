...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Số lượng: ${total}";

  static String m15(percent) => "Sale ${percent} %";
  ...
  static String m18(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m19(total) => "${total} sản phẩm";

  static String m20(date) => "Có hiệu lực cho đến ${date}";
  ...
  static String m23(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m24(week) => "Tuần ${week}";

  static String m25(year) => "${year} năm trước";

  static String m26(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
