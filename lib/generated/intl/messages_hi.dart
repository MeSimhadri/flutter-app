...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "मात्रा: ${total}";

  static String m15(percent) => "बिक्री ${percent} %";

  static String m16(second) => "${second} सेकंड पहले";

  static String m17(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m18(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m19(total) => "${total} उत्पाद";

  static String m20(date) => "मान्य तिल ${date}";

  static String m21(message) => "चेतावनी: ${message}";
  ...
  static String m23(length) => "हमें ${length} उत्पाद मिले";

  static String m24(week) => "सप्ताह ${week}";

  static String m25(year) => "${year} साल पहले";

  static String m26(total) => "आपने #${total}ऑर्डर करने के लिए असाइन किया है";
