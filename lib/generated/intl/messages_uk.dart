...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Кількість: ${total}";

  static String m15(percent) => "Продаж ${percent}%";

  static String m16(second) => "${second} секунд тому";

  static String m17(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m18(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m19(total) => "${total} продуктів";

  static String m20(date) => "Діє до ${date}";

  static String m21(message) => "Попередження: ${message}";

  static String m22(default_currency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${default_currency}";

  static String m23(length) => "Ми знайшли ${length} продуктів";

  static String m24(week) => "Тиждень ${week}";

  static String m25(year) => "${year} років тому";

  static String m26(total) => "Ви призначили замовлення №${total}";
