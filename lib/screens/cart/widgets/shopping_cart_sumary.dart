...
class _ShoppingCartSummaryState extends State<ShoppingCartSummary> {
  ...
  final bool _showCouponList = (kAdvanceConfig['ShowCouponList'] ?? false) && Config().type != ConfigType.magento;
  @override
  void initState() {
    super.initState();
    getCoupon();
...
//      print(e.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CartModel>(builder: (context, cartModel, child) {
      ...
      final enableCoupon = (kAdvanceConfig['EnableCouponCode'] ?? true) && !cartModel.isWalletCart();
