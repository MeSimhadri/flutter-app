...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "수량: ${total}";

  static String m15(percent) => "판매 ${percent} %";

  static String m16(second) => "${second} 초 전";

  static String m17(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m18(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m19(total) => "${total} 제품";

  static String m20(date) => " ${date}까지 유효";

  static String m21(message) => "경고 : ${message}";

  static String m22(default_currency) =>
      "현재 선택한 통화는 지갑 기능에 사용할 수 없습니다. ${default_currency}(으)로 변경하십시오.";

  static String m23(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m24(week) => "주 ${week}";

  static String m25(year) => "${year} 년 전";

  static String m26(total) => "주문 번호${total}에 할당했습니다.";
