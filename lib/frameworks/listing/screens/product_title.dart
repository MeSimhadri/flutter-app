  ...
  Widget build(BuildContext context) {
    ...
    if (isNotBlank(product!.email)) {
      list.add(InfoItem(
        ...
        title: product!.email,
        onTap: () async {
          _launchURL('mailto:' + product!.email!);
        },
      ));
    }
      ...
      children: <Widget>[
        if (isNotBlank(product!.whatsapp))
          SocialItem(
            ...
            onTap: () async {
              _launchURL('whatsapp://send?phone=' + product!.whatsapp!);
            },
          ),
        if (isNotBlank(product!.skype))
          SocialItem(
            ...
            icon: Icons.chat,
            onTap: () async {
              _launchURL('im:<sip:${product!.skype}>');
            },
          ),
