...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Qty: ${total}";
  ...
  static String m19(total) => "${total} products";
  ...
  static String m23(length) => "We found ${length} products";

  static String m24(week) => "Week ${week}";

  static String m25(year) => "${year} years ago";

  static String m26(total) => "You have assigned to order #${total}";
