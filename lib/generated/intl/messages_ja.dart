...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "数量： ${total}";

  static String m15(percent) => "セール${percent}％";
  ...
  static String m19(total) => "${total} 製品";

  static String m20(date) => " ${date}まで有効";
  ...
  static String m23(length) => "${length} 個の商品が見つかりました";

  static String m24(week) => "週 ${week}";

  static String m25(year) => "${year} 年前";

  static String m26(total) => "注文番号${total}に割り当てました";
