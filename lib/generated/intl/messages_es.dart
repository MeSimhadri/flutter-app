...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Cantidad: ${total}";

  static String m15(percent) => "Rebaja ${percent} %";

  static String m16(second) => "${second} segundos";
  ...
  static String m19(total) => "${total} Productos";

  static String m20(date) => "Válido hasta ${date}";

  static String m21(message) => "Advertencia: ${message}";
  ...
  static String m23(length) => "Encontramos productos de ${length}";

  static String m24(week) => "Semana ${week}";

  static String m25(year) => " Hace${year} años";

  static String m26(total) => "Ha asignado a la orden #${total}";
