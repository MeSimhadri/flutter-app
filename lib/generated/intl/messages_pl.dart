...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Ilość: ${total}";

  static String m15(percent) => "Wyprzedaż ${percent}%";

  static String m16(second) => "${second} sekundy temu";

  static String m17(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m18(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m19(total) => "${total} produktów";

  static String m20(date) => "Ważne do ${date}";

  static String m21(message) => "Ostrzeżenie: ${message}";
  ...
  static String m23(length) => "Znaleźliśmy ${length} produktów";

  static String m24(week) => "Tydzień ${week}";

  static String m25(year) => "${year} lat temu";

  static String m26(total) => "Przypisałeś do zamówienia nr${total}";
