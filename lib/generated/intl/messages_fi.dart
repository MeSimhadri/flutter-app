...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} päivää sitten";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Päättyy ${timeLeft}";

  static String m4(message) => "Virhe: ${message}";

  static String m5(time) => "Vanhenee ${time}kuluttua";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} tuntia sitten";
  ...
  static String m9(size) => "Tiedoston enimmäiskoko: ${size} Mt";

  static String m10(minute) => "${minute} minuuttia sitten";

  static String m11(month) => "${month} kuukautta sitten";

  static String m12(itemCount) => "${itemCount} kohdetta";

  static String m13(price) => "Vaihtoehdot yhteensä: ${price}";

  static String m14(total) => "Määrä: ${total}";

  static String m15(percent) => "Alennus ${percent}%";

  static String m16(second) => "${second} sekuntia sitten";

  static String m17(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m18(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m19(total) => "${total} tuotetta";

  static String m20(date) => "Voimassa ${date}asti";

  static String m21(message) => "Varoitus: ${message}";

  static String m22(default_currency) =>
      "Valittu valuutta ei ole käytettävissä Wallet -ominaisuudessa, vaihda se arvoon ${default_currency}";

  static String m23(length) => "Löysimme ${length} tuotetta";

  static String m24(week) => "Viikko ${week}";

  static String m25(year) => "${year} vuotta sitten";

  static String m26(total) => "Olet määrittänyt tilauksen #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "warning": m21,
        "warningCurrencyMessageForWallet": m22,
        "weFoundBlogs":
