...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Qtà: ${total}";

  static String m15(percent) => "${percent}% di sconto";
  ...
  static String m19(total) => "${total} Prodotti";

  static String m20(date) => "Valido fino alle ${date}";
  ...
  static String m23(length) => "Abbiamo trovato \$length prodotti";

  static String m24(week) => "Settimana ${week}";

  static String m25(year) => "${year} anni fa";

  static String m26(total) => "Hai assegnato all\'ordine #${total}";
