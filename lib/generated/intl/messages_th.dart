...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "จำนวน: ${total}";

  static String m15(percent) => "ยอดขาย ${percent} %";

  static String m16(second) => "${second} วินาทีที่ผ่านมา";
  ...
  static String m19(total) => "${total} สินค้า";

  static String m20(date) => "ใช้ได้จนถึง ${date}";

  static String m21(message) => "คำเตือน: ${message}";
  ...
  static String m23(length) => "เราพบสินค้า ${length}";

  static String m24(week) => "สัปดาห์ ${week}";

  static String m25(year) => "${year} ปีที่แล้ว";

  static String m26(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
