...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Adet: ${total}";

  static String m15(percent) => "% ${percent} İndirim ";

  static String m16(second) => "${second} Saniye önce";

  static String m17(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m18(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m19(total) => "${total} ürün";

  static String m20(date) => " ${date}tarihine kadar geçerlidir";
  ...
  static String m23(length) => " \$${length} Ürün Bulundu";

  static String m24(week) => " ${week}haftası";

  static String m25(year) => "${year} yıl önce";

  static String m26(total) => "#${total}numaralı siparişe atadınız";
