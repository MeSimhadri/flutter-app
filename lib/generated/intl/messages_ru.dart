...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(total) => "Кол-во: ${total}";

  static String m15(percent) => "Распродажа ${percent} %";

  static String m16(second) => "${second} секунд назад";
  ...
  static String m19(total) => "${total} продуктов";

  static String m20(date) => "Действительно до ${date}";

  static String m21(message) => "Предупреждение: ${message}";
  ...
  static String m23(length) => "Мы нашли товары";

  static String m24(week) => "Неделя ${week}";

  static String m25(year) => "${year} лет назад";

  static String m26(total) => "Вы назначили заказ №${total}";
