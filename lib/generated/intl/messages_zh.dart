...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(percent) => "出售${percent}%";

  static String m16(second) => "${second} 秒前";

  static String m17(totalCartQuantity) => "购物车, ${totalCartQuantity} 件商品";

  static String m18(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m19(total) => "${total} 个产品";

  static String m20(date) => "有效期至 ${date}";

  static String m21(message) => "警告: ${message}";

  static String m22(default_currency) =>
      "当前选择的货币不适用于电子钱包功能，请将其更改为 ${default_currency}";

  static String m23(length) => "我们找到 ${length} 个产品";

  static String m24(week) => "周 ${week}";

  static String m25(year) => "${year} 年前";

  static String m26(total) => "您已指定订单 #${total}";
